...
import { Component, Node, Vec3, tween, Quat, Sprite, Color, math, easing, Camera, ITweenOption,} from 'cc';
...
declare module "cc" {
    interface Node {
        ...
        jumpZ : number;
        jumpOffsetY : number;
        qtJumpPosition(to: Vec3, jumpHeight: number, jumpNum: number, duration: number, opts?: ITweenOption): Tween;
    }
}

// 实现扩展
if (!EDITOR_NOT_IN_PREVIEW) {
    Object.defineProperty(Node.prototype, "qtJumpPosition", {
        value: function(to: Vec3, jumpHeight: number, jumpNum: number, duration: number, opts?: ITweenOption) {
...
// Node.prototype.setScaleX = function(x:number){
//     this.setScale(x, this.scale.y)
// }
// Node.prototype.setScaleY = function(y:number){
